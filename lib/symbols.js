...
let symbols = {
  ...
  '7️⃣': {name : 'Digit Seven',
        id : 'seven',
        codePoint :'0x37',
        emoji : [[0x37,0xFE0F,0x20E3],
                 [0x37,0x20E3]]},

  '8️⃣': {name : 'Digit Eight',
        id : 'eight',
        codePoint :'0x38',
  ...
  // Level 4 - Basic Robot Control
  '⬆️': {name : 'Upwards Black Arrow',
        id: 'arrow_up',
        alias: ['forward'],
        codePoint :'0x2B06',
        emoji : [[0x2B06,0xFE0F],
                 [0x2B06,0xFE0F,0x20E3]]},

  '⬇️': {name : 'Downwards Black Arrow',
        id: 'arrow_down',
        alias: ['back','backwards','reverse'],
        codePoint :'0x2B07',
        emoji : [[0x2B07,0xFE0F],
                 [0x2B07,0xFE0F,0x20E3]]},

  '↩️': {name : 'Leftwards Arrow With Hook',
        id : 'arrow_clockwise',
        alias: ['turn_right','right_turn'],
        codePoint :'0x21A9',
        emoji : [[0x21A9,0xFE0F],
                 [0x21A9,0xFE0F,0x20E3]]},
        // Alt: "clockwise open circle arrow (U+21BB)"
        // code: 0x21bb
        // glyph: ↻

  '↪️': {name : 'Rightwards Arrow With Hook',
        id : 'arrow_anticlockwise',
        alias: ['turn_left','left_turn'],
        codePoint :'0x21AA',
        emoji : [[0x21AA,0xFE0F],
                 [0x21AA,0xFE0F,0x20E3]]},
  ...
  '✖️': {name : 'Heavy Multiplication X',
        id : 'multiply',
        alias: ['times'],
        codePoint :'0x2716',
        emoji : [[0x2716,0xFE0F],
                 [0x2716,0xFE0F,0x20E3]]},
  ...
  '➡️': {name : 'Black Rightwards Arrow',
        id : 'arrow_right',
        alias: ['right'],
        codePoint :'0x27A1',
        emoji : [[0x27A1,0xFE0F],
                 [0x27A1,0xFE0F,0x20E3]]},

  '⬅️': { name : 'Leftwards Black Arrow',
        id : 'arrow_left',
        alias: ['left'],
        codePoint :'0x2B05',
        emoji : [[0x2B05,0xFE0F],
                 [0x2B05,0xFE0F,0x20E3]]},
